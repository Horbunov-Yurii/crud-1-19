...
(0, _getIce.getIce)().then((res)=>createItemsMarcups(res));
...
},{}],"a0fTv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "postIce", ()=>postIce);
const postIce = (iceData)=>{
    const options = {
        method: "POST",
...
//# sourceMappingURL=crud-1-19.0f77c784.js.map
